...
(function() {
    ...
    // your code here
    // Au clic sur le bouton, affiche (console) l'un après l'autre le nom de chaque personne du tableau people.
    //  Utilise la méthode map
    
    document.getElementById("run").addEventListener("click", function(){

        var peopleMap = people.map(x=>console.log(x.firstname));

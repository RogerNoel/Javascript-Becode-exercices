...
document.getElementById("run").addEventListener("click", function() {
    ...
    for (var i = 0; i < people.length; i++) {
            if (people[i].firstname === "Jean" && people[i].lastname === "Dupont") {  
                console.log("L'adresse mail de " + people[i].firstname + " " + people[i].lastname + " est " + people[i].email+".");
                console.log("Son numéro d'index est " + i+".");
            }
    }
});
    // test -- > console.log(people[5].firstname);
